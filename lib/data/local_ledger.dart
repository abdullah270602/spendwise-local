...
final class LocalLedger {
  ...
  void resetEvidenceRefreshForTests() => _db.execute(
    "DELETE FROM app_settings WHERE key = 'refresh_stored_evidence_v7'",
  );
  ...
  void _refreshStoredEvidenceInner() {
    final done = _db.select(
      "SELECT 1 FROM app_settings WHERE key = 'refresh_stored_evidence_v7'",
    );
    ...
    _db.execute(
      "INSERT OR REPLACE INTO app_settings(key,value) VALUES ('refresh_stored_evidence_v7','done')",
    );
