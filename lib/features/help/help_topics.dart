...
List<HelpTopic> helpTopics(SpendWiseViewModel viewModel) => [
  ...
  HelpTopic(
    ...
    brief:
        ...
        'One account you did not add is Cash. When your bank says you '
        'withdrew money, that money did not leave you, it changed pocket, so '
        'it moves into Cash instead of counting as something you spent. It '
        'becomes spending when you say what it bought, because a banknote '
        'changing hands sends no alert to read. Nothing ever takes money out '
        'of Cash on its own. '
        'When a '
  ...
  HelpTopic(
    ...
    brief:
        ...
        'open the entry in Ledger, open "Whose money was this?" and answer '
        'it. There are three answers, and any one entry is offered the two '
        'its direction allows — money that left your account can only have '
        'been lent or held, money that arrived can only have been borrowed or '
        'held, and money moving between your own accounts is none of them. '
        '"I lent it out" is money that left and '
        ...
        'never yours: somebody parking money with you, or a collection you '
        'are the keeper of. '
        ...
        'or hand-overs in part or in full whenever they happen. One that '
        'arrived as a bank alert is attached to that entry rather than typed '
        'in: open the entry and record it against the loan, or open the loan '
        'and pick the entry, which SpendWise offers when one looks like it. '
        'Attaching it is what stops the same money counting twice, once as '
        'the loan closing and again as a month you earned it in. An entry '
        'that has been attached shows the loan it belongs to: the principal, '
        'how much has come back, how much is still out, and the payments '
        'that brought it, so a loan half home reads differently from one '
        'nobody has paid into. Cash that '
        'never touched a bank has no entry to attach, so it is recorded as '
        'an amount on the loan alone. None of the three '
