...
```text
Notifications / CSV / Manual entry
                 |
                 v
             Raw events
                 |
...
See [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) for the detailed invariants.
